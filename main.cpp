...
private:
    ...
    void createDescriptorSets(){
        ...
        VkResult descriptorSetsResult = vkAllocateDescriptorSets(device, &allocInfo, descriptorSets.data());
    ...
    void createDescriptorPool(){
        ...
        VkResult descriptorPoolResult = vkCreateDescriptorPool(device, &poolInfo, nullptr, &descriptorPool);
    ...
    void createDescriptorSetLayout(){
        ...
        VkResult descriptorSetLayoutResult = vkCreateDescriptorSetLayout(device, &layoutInfo, nullptr, &descriptorSetLayout);
